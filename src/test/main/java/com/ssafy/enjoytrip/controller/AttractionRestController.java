...
@Slf4j
@CrossOrigin("*") // 모든 요청에 대해 CORS 허용 (Vue 연동 필수)
public class AttractionRestController {
	...
	public ResponseEntity<?> getAreaBasedList(
		...
		log.info("[list] 관광지 목록 조회 요청 - areaCode: {}, contentTypeId : {}", areaCode, contentTypeId);
		try {
			String result = attractionService.getAreaBasedList(areaCode, contentTypeId);
